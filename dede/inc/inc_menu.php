...
<m:top item='1_' name='常用操作' display='block'>
  ...
  <m:item name='内容回收站' link='recycling.php' addalt='清空回收站' rank='a_List,a_AccList,a_MyList' target='main' />
</m:top>
<m:top item='1_' name='HTML更新' notshowall='1' display='none' rank='sys_MakeHtml' >
